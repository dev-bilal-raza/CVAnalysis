...
const ShowDataPopup = ({
  ...
  return (
    <div
      className={`fixed inset-0 z-50 flex backdrop-blur-md items-center justify-center
    ...
    >
      ...
      {/* Modal Content */}
      <div
        className={`relative w-full max-w-4xl mx-4  bg-[#FFFFFF] rounded-lg ${isClosing ? 'animate-slideOutDown' : 'animate-slideInUp'}`}
      >
        <Container>
          <div className="flex flex-col p-1 py-3 exsmall:p-3 sm:p-6">
            ...
            <div className="flex items-center justify-between mb-6">
              {data.heading && (
                <div className="flex-1 pr-4">
                  ...
                  <h3
                    aria-valuetext={data.heading}
                    className="exsmall:block sm:hidden hidden text-tooltip relative text-center font-heading text-lg exsmall:text-xl sm:text-2xl md:text-3xl font-semibold text-gray-900 group-hover:text-gray-600 transition-colors"
                  >
                  ...
                  <h3
                    aria-valuetext={data.heading}
                    className="exsmall:hidden block text-tooltip relative text-center font-heading text-lg exsmall:text-xl sm:text-2xl md:text-3xl font-semibold text-gray-900 group-hover:text-gray-600 transition-colors"
                  >
                    {data.heading?.length > 10
                      ? data.heading?.slice(0, 10) + '...'
                      : data.heading}
                  </h3>
                </div>
              )}
            ...
            <div className="relative overflow-hidden">
              ...
              <div className="relative">
                <div
                  className="p-3 exsmall:p-6 bg-[#F0E8F5] rounded-sm 
                ...
                >
                  <div className="max-h-[60vh] overflow-auto">
                    <p
                      className="font-para text-[14px]  md:text-[16px] font-light text-gray-800 leading-relaxed
