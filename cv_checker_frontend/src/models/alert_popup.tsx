...
const DeletePopup = ({
  ...
  return (
    isAllowed && (
      <div
        className={`${isAllowed ? 'animate-fadeIn animate-slideInUp' : 'animate-slideOutDown'} absolute z-10 h-full right-0 left-0 bg-white transition-all duration-1000 flex justify-center items-start`}
      >
