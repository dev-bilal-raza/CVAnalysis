                            ...
                            <div className='sm:w-3/4 mx-auto'>
                                <div className='flex flex-col gap-3'>
                                    ...
                                    <div className='bg-[#F0E8F5] p-2.5 px-4 rounded-xl flex items-end gap-2'>
                                        <Image src='/Icons/SearchIcon.png' alt='search' width={19} height={19} />
                                        <input
                                            type="text"
                                                        ...
                                                        <div key={index} className={`w-full flex my-8 justify-between ${index % 2 !== 0 ? "" : ""}`}>
                                                            <div className='flex gap-2 items-start'>
                                                                ...
                                                                <div>
                                                                    ...
                                                                    <h5 className='font-para text-[12px] sm:text-sm text-blue-600 hover:text-blue-500 cursor-pointer font-light' onClick={() => descriptionHandler(job.job_id)}>
                                                                        View Description
                                                                    </h5>
                                                                </div>
                                                            </div>
                                                            <div className='flex gap-2 exsmall:gap-4 items-center'>
                                                                <div className='cursor-pointer p-2 px-3 exsmall:px-4 md:px-6 border border-[#1E1B4B] rounded-md' onClick={() => popupHandler(job.job_id)}>
                                                                    <Image src={"/Icons/TrashIcon.png"} alt='Delete Job' width={16} height={16} />
                                                                </div>
                                                                <Button is_delete={false} click_func={() => router.push(`/analyze_cv/${job.job_id}`)}>
                                                                    View CVs
                                                                </Button>
                                                            </div>
                                                        </div>
