          ...
          <div>
            <div className='relative'>
              ...
              <div className='absolute z-20 w-full mx-auto'>
                <h2 className='font-heading text-xl text-center exsmall:text-2xl sm:text-3xl md:text-4xl font-bold'>{jobDetails?.job_title}</h2>
              </div>
              <div className='absolute z-10 bg-white/40 shadow-[inset_23px_-16px_52px_16px_#FFFF] h-[200px] w-full'>
              </div>
                      ...
                      <div className='m-6 w-full'>
                        {cv.is_recommended &&
                          <div className='flex gap-3 items-center'>
                            <div className={`inline-flex justify-center items-center h-14 w-14 rounded-full ring-4 ring-gray-300 ${cv.recommendation_points > 8 ? "bg-green-600" : "bg-[#2e235d]"}`}>
